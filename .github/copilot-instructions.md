...
- Migrations (native only): If entities change, add a TypeORM migration and reference it in src/db/data-source.ts. Do not rely on synchronize for native.
- Secrets: Do not hardcode or alter CI secrets. Do not change .github/workflows/release.yml or fastlane unless instructed.
